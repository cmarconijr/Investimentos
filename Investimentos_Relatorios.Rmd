...
- \pagestyle{fancy}
- \fancyhead{}
- \fancyhead[CO,CE]{Brasil - Portugal, Dados de Investimentos}
- \fancyfoot[CO,CE]{}
...
# if(pais != FALSE){
  ...
  IDP_Por_Setor_Inv_Imed$Setores <- c("Indústrias Extrativas", "Comércio, Reparação de Veículos Automotores e Motocicletas", "Eletricidade e Gás", "Indústrias de Transformação", "Atividades Financeiras, de Seguros e Serviços Relacionados", "Transporte, Armazenagem e Correio","Outros")
  ...
  IDP_Por_Setor_Control_Final$Setores <- c("Indústrias Extrativas", "Comércio, Reparação de Veículos Automotores e Motocicletas", "Eletricidade e Gás", "Indústrias de Transformação", "Atividades Financeiras, de Seguros e Serviços Relacionados", "Transporte, Armazenagem e Correio","Outros")
